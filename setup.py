...
try:
    ...
    cursor.execute(
        "CREATE TABLE PROFILES(USER VARCHAR(50) NOT NULL PRIMARY KEY, PASSWORD VARCHAR(50) NOT NULL, EMAIL VARCHAR(50), EMAILPASS VARCHAR(50), DISCORD VARCHAR(20), CLEARANCE_LEVEL INT);")
