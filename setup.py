...
try:
    ...
    cursor.execute("CREATE TABLE FINANCE(ID INT AUTO_INCREMENT PRIMARY KEY, OWNING_USER VARCHAR(200), DATE VARCHAR(50) NOT NULL, TITLE MEDIUMTEXT, MEMO MEDIUMTEXT, DEPOSIT VARCHAR(50), AMOUNT INT, ACCOUNT_BALANCE INT);")
